describe("App", function() { //seegun al documentacion esto es algo como casos de prueba pero no entiendo bien como se  hace el llamada 
	...
	describe("Login", function() { //cuando hace el login correctamente ejecuta esto 

			it("authenticates successfully with correct credentials", function() {
				//estoy leyendo  sobre  $httpBackend    ya que nunca lo habia  usado 
